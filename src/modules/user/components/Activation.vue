          ...
          <v-stepper-items>
            <v-stepper-content step="1">
              <v-card text class="rounded-lg">
                ...
                <v-card-title primary-title class="justify-space-around mb-0 pb-0">
                  <h3 class="tittle primary--text d-block text-center">Pencocokan Akun</h3>
                </v-card-title>
                <v-card-text>
                  <v-form data-vv-scope="form-cekToken" lazy-validation>
                    <v-row column wrap>
                      <v-col cols="12" class="justify-space-around text-center"
                        >Silakan melakukan proses pencocokan akun Anda dengan Instansi Anda melalui input Kode Token
                        yang Anda dapat</v-col
                      >
              ...
              <v-card text class="rounded-lg mb-0 pb-0">
                ...
                <v-card-actions class="pt-0 mt-0">
                  <v-btn
                    ...
                    color="secondary"
                    @click="passpor && passpor.status == 2 ? proses() : setPassword()"
                    style=" webkit-box-shadow: 0px 2px 7px 5px #D3D3D3;"
            ...
            <v-stepper-content step="3">
              <v-card text class="rounded-lg">
                ...
                <v-card-title primary-title class="justify-space-around mb-0 pb-0">
                  <h3 class="tittle primary--text d-block text-center">Masukkan Kode Aktivasi</h3>
                </v-card-title>
                <v-card-text>
                  <v-form data-vv-scope="form-aktivasi" lazy-validation>
                    <v-row column wrap>
                      <v-col cols="12" class="justify-space-around text-center"
                        >Kode Aktivasi bisa Anda dapatkan dari surel yang dikirim oleh sistem</v-col
                      >
                      <v-col cols="12" class="my-3 py-0">
                        <v-text-field
                          label="Kode Token"
                ...
                <v-card-text class="black--text">
                  <div v-if="user">
                    <p class="my-0 text-center"
                      >Surel Anda :
                      <a class="blue--text text-center" :href="'mailto:' + user.email"
                        ><u>{{ pVal(user, 'email') }}</u></a
                      ></p
                    >
  ...
  methods: {
    ...
    proses() {
      ...
      this.$validator
        ...
        .then(() => {
          return this.$store
            .dispatch('user/aktivasiToken', { email: this.user.email, token: this.token })
            .then((res) => {
              this.st = 4
              this.dialog = true
              return res
    ...
    aktivasi() {
      ...
      this.$validator
        ...
        .then(() => {
          return this.$store
            .dispatch('user/aktivasiByKode', { kodeAktivasi: this.kodeAktivasi })
            .then((res) => {
              this.st = 4
              this.dialog = true
              return res
